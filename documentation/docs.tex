...
Sei eine elementare Funktion $f$ gegeben.\\
 Der erste Schritt besteht darin, geeignete $\theta_1,\dots,\theta_n$ zu finden, sodass $f\in\mathbb{C}(x,\theta_1,\dots,\theta_n)$. Diesen Schritt werde ich hier überspringen und bei meinem Programm dem Benutzer überlassen. Vielleicht werde ich später eine automatische Funktion hierfür entwickeln, die dann auf \textit{Github} zu finden ist. Außerdem beschränke ich mich hier und in der Implementierung auf rein transzendente Körpererweiterungen, d.h. z.B. Wurzelfunktionen lassen sich hiermit nicht integrieren.\\
