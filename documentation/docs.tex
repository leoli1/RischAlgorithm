...
\begin{definition}
Sei $F$ ein Körper. Ein Polynom $p\in F[t]$ heißt \textup{quadratfrei}, falls es nicht von einem Quadrat geteilt wird, d.h. es gibt kein $q\in F[t]$ mit $q^2\mid p$.
\end{definition}
...
\begin{align*}
f\textrm{ ist quadratfrei}\quad \Longleftrightarrow\quad \ggT(f,\frac{d}{dx})=1
\end{align*}
